...
-(void)tapViewExpand:(UITapGestureRecognizer *)sender {
    ...
    if (tableViewY + tableHeight < CGRectGetHeight([UIScreen mainScreen].bounds) - 100) {
        tableViewFrame.size.height = tableHeight;
    }else {
        tableViewFrame.size.height = CGRectGetHeight([UIScreen mainScreen].bounds) - frame.origin.y - 100;
    }
