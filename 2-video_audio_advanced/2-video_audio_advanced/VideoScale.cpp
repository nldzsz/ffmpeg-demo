...
VideoScale::VideoScale():en_ctx(NULL),de_ctx(NULL),ou_fmt(NULL),in_fmt(NULL),inputs(NULL),ouputs(NULL),src_filter_ctx(NULL),sink_filter_ctx(NULL)
...
void VideoScale::internalrelease()
{
    if (en_ctx) {
...
void VideoScale::doVideoScale()
{
    ...
    string dstpath = srcDic + "1-videoscale_1.mp4";
    dst_width = 840;
    dst_height = 440;
...
void VideoScale::doVideoDecodec(AVPacket *pkt)
{
...
void VideoScale::doVideoEncode(AVFrame *frame)
{
