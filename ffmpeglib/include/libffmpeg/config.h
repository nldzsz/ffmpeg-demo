...
#define FFMPEG_CONFIGURATION "--enable-small --enable-runtime-cpudetect --disable-debug --disable-all --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --disable-postproc --disable-avresample --disable-hwaccels --disable-encoders --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=mpeg1video --enable-encoder=mp2 --enable-encoder=mjpeg --disable-decoders --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder=mpeg1video --enable-decoder=mp2float --enable-decoder=mjpeg --disable-muxers --enable-muxer=mpegts --enable-muxer=mpeg1system --enable-muxer=flv --enable-muxer=avi --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=adts --enable-muxer=mp3 --enable-muxer=ac3 --enable-muxer=image2 --disable-demuxers --enable-demuxer=mpegts --enable-demuxer=mpegps --enable-demuxer=mpegvideo --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ac3 --enable-demuxer=image2 --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=mpegvideo --disable-filters --enable-filter=aformat --enable-filter=aresample --enable-filter=volume --enable-filter=scale --enable-filter=transpose --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=extract_extradata --disable-protocols --enable-protocol=file --enable-encoder=h264_videotoolbox --enable-gpl --enable-libx264 --enable-encoder=libx264 --enable-decoder=h264 --enable-libmp3lame --enable-encoder=libmp3lame --enable-decoder=mp3float --prefix=/Users/apple/devoloper/mine/ffmpeg/ffmpeg-demo/ffmpeglib --extra-cflags=' -I/Users/apple/devoloper/mine/ffmpeg/ffmpeg-build-scripts/mac/build/x264-x86_64/include -I/Users/apple/devoloper/mine/ffmpeg/ffmpeg-build-scripts/mac/build/mp3lame-x86_64/include' --extra-ldflags=' -L/Users/apple/devoloper/mine/ffmpeg/ffmpeg-build-scripts/mac/build/x264-x86_64/lib -L/Users/apple/devoloper/mine/ffmpeg/ffmpeg-build-scripts/mac/build/mp3lame-x86_64/lib ' --disable-optimizations"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/apple/devoloper/mine/ffmpeg/ffmpeg-demo/ffmpeglib/share/ffmpeg"
#define AVCONV_DATADIR "/Users/apple/devoloper/mine/ffmpeg/ffmpeg-demo/ffmpeglib/share/ffmpeg"
